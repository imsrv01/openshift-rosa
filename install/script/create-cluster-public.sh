...
# Create cluster
rosa create cluster --cluster-name=<cluster_name> --sts --mode=auto --hosted-cp --oidc-config-id <ID-of-OIDC-configuration> --subnet-ids=<public-subnet-id>,<private-subnet-id> -y
